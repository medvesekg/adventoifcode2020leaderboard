    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div style="border-bottom: 2px solid #eaeaea">
        <ul class="flex cursor-pointer">
          <li class="py-2 px-6 bg-white rounded-t-lg" :class="activeClass('PersonalTable')" @click="table='PersonalTable'">Personal</li>
          <li class="py-2 px-6 bg-white rounded-t-lg" :class="activeClass('TeamsTable')" @click="table='TeamsTable'">
            Teams
          </li>
        </ul>
      </div>
...
export default {
  components: { PersonalTable, TeamsTable, AppAchievement },
  ...
  methods: {
    ...
    activeClass(tab) {
      return tab === this.table ? 'text-gray-500 bg-gray-200' : null
    },
  },
};
</script>
